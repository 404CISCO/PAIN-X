...
###################################################################################################
#                                                                                                 #
#        PPPPPPPPPPPPPPPPP          AAA                IIIIIIIIII  NNNNNNNN        NNNNNNNN       #
#        P::::::PPPPPP:::::P      A:::::A              I::::::::I  N::::::::N      N::::::N       #
#        PP:::::P     P:::::P    A:::::::A             II::::::II  N:::::::::N     N::::::N       #
#          P::::P     P:::::P   A:::::::::A              I::::I    N::::::::::N    N::::::N       #
#          P::::P     P:::::P  A:::::A:::::A             I::::I    N:::::::::::N   N::::::N       #
#          P::::PPPPPP:::::P  A:::::A A:::::A            I::::I    N:::::::N::::N  N::::::N       #
#          P:::::::::::::PP  A:::::A   A:::::A           I::::I    N::::::N N::::N N::::::N       #
#          P::::PPPPPPPPP   A:::::A     A:::::A          I::::I    N::::::N  N::::N:::::::N       #
#          P::::P          A:::::AAAAAAAAA:::::A         I::::I    N::::::N   N:::::::::::N       #
#          P::::P         A::::AAAAAAAAAAAAA::::A        I::::I    N::::::N    N::::::::::N       #
#          P::::P        A:::::::::::::::::::::::A       I::::I    N::::::N     N:::::::::N       #
#          P::::P       A:::::A             A:::::A      I::::I    N::::::N      N::::::::N       #
#        P::::::::P    A:::::A               A:::::A   I::::::::I  N::::::N       N:::::::N       #
#        P::::::::P   A:::::A                 A:::::A  I::::::::I  N::::::N        N::::::N       #
#        PPPPPPPPPP  AAAAAAA                   AAAAAAA IIIIIIIIII  NNNNNNNN         NNNNNNN       #
#                                                                                                 #      
###################################################################################################{reset}
        {blue}Developed by Inam Ullah{reset}
      {gold}AI-powered CMD & Terminal assistant{reset}
{reset}
"""
print(banner)
...
def mode_selection():
    ...
    while True:
        ...
        if choice == "1":
            ...
            print(f"{red}Okay, exiting Pain. Catch ya later!{reset}")
            sys.exit()
        else:
...
while True:
    ...
    while True:
        # Get user input
        print(f"{green}\nPain ({mode})> {reset}", end="") # Changed prompt slightly
        ...
        if user_input.lower() in ["quit", "exit"]:
            print(f"\n{red}Alright, shutting down Pain. Hope it was helpful!{reset}")
            sys.exit()
